...
class MaintenanceController extends Controller {
	...
	*/
	...
	public function showMaintenance(Request $request)
	{
		...
		return View::make('pages.service.maintenance', array('user'=>Auth::user(), 'submenu'=>'maintenance', 'menu'=>'services', 'estate_id'=>$estate_id,'jobs'=>$jobs, 'rolesetting'=>$RoleSetting, 'estate'=>$estate));
	}	
	...
	public function uploadAttach($file, $id, $seq, $filetype)
	{
		...
		$file->move(public_path('uploads/images/attach/'.$filetype.'/'), $filename);
	...
	public function viewMaintenance(Request $request)
	{
		...
		return View::make('pages.service.maintenance_detail', array('user'=>Auth::user(), 'submenu'=>'maintenance', 'menu'=>'facility', 'estate_id'=>$estate_id, 'maintenance'=>$result, 'attaches'=>$attaches, 'rolesetting'=>$RoleSetting, 'estate'=>$estate));
	}
