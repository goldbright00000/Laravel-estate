...
class CouncilCommitteeController extends Controller {
	...
	*/
	...
	public function showCouncilCommittee(Request $request)
	{
		...
		return View::make('pages.community.council_committee', array('user'=>Auth::user(), 'submenu'=>'council_committee', 'menu'=>'community', 'estate_id'=>$estate_id, 'rolesetting'=>$RoleSetting, 'estate'=>$estate));
	}	
}	