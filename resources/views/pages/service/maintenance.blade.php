...
<div class="page-container">
  ...
  <div class="page-content-wrapper">
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12">
          <ul class="nav nav-tabs">
            ...
            <li>
              <a href="#tab_reversed_1_3" data-toggle="tab">
                Job category count </a>
            </li>

            <li>
              <a href="#tab_reversed_1_4" data-toggle="tab">
                Maintenance & Repair Trend </a>
            </li>

            <li>
              <a href="#tab_reversed_1_5" data-toggle="tab">
                Maintenance & Repair Aging </a>
            </li>
          </ul>
          <div class="tab-content">
            ...
            <div class="tab-pane fade" id="tab_reversed_1_3">
              <div class="portlet box green">
                ...
                <div class="portlet-body">
                  <table class="table table-striped table-bordered table-hover" id="jobs_category_count_tb">
                    <thead>
                    <tr>
                      <th>
                        Category
            ...
            <div class="tab-pane fade" id="tab_reversed_1_4">
              <div class="portlet box green">
                ...
                <div class="portlet-body">
                  <table class="table table-striped table-bordered table-hover" id="repair_trend_tb">
                    <thead>
                    <tr>
                      <th>
                        Category
            ...
            <div class="tab-pane fade" id="tab_reversed_1_5">
              <div class="portlet box green">
                <div class="portlet-title">
                  <div class="caption">
                    <i class="fa fa-truck"></i>Maintenance & Repair Jobs
                ...
                <div class="portlet-body">
                  <table class="table table-striped table-bordered table-hover" id="repair_aging_tb">
                    <thead>
                    <tr>
                      <th>
                        Created Date
                      ...
                      <th> Status</th>
                      <th> Days Open</th>
                      <th> Estimated Completition Date</th>
            ...
            <form role="form" id="edit-form">
              <div class="form-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-9">
                    <textarea type="text" class="form-control" rows="5" name="details"
                ...
                <div class="row">
                  <div class="fileinput fileinput-new col-md-4" data-provides="fileinput">
                    ...
                    <div>
                                    ...
                                    Change </span>
                                    <input type="hidden" value="" name=""><input type="file" name="attach1"
                                                                                 accept="image/*">
                                    </span>
                  ...
                  <div class="fileinput fileinput-new col-md-4" data-provides="fileinput">
                    ...
                    <div>
                                    ...
                                    <span class="fileinput-exists">
                                    Change </span>
                                    <input type="hidden" value="" name=""><input type="file" name="attach2"
                                                                                 accept="image/*">
                                    </span>
                      <a href="javascript:;" class="btn red fileinput-exists" data-dismiss="fileinput">
                        Remove </a>
                  ...
                  <div class="fileinput fileinput-new col-md-4" data-provides="fileinput">
                    ...
                    <div>
                                    ...
                                    <span class="fileinput-exists">
                                    Change </span>
                                    <input type="hidden" value="" name=""><input type="file" name="attach3"
                                                                                 accept="image/*">
                                    </span>
                      <a href="javascript:;" class="btn red fileinput-exists" data-dismiss="fileinput">
                        Remove </a>
    ...
    {{ Html::script('js/service/maintenance.js') }}
