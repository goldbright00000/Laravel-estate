                ...
                <div class="col-md-12 col-sm-12">
                    ...
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-user"></i>Facility Booking Management
                            </div>
                            <div class="actions">
                                <a href="javascript:;" class="btn blue btn-sm btn-new">
                                <i class="fa fa-plus"></i> New Facility </a>
                            </div>
                        </div>
                        <div class="portlet-body">
                            <table class="table table-striped table-bordered table-hover" id="book_tb">
                                <thead>
                                    <tr>
                                        <th>
                                             Facility
...
<!-- BEGIN MODALS -->
<div id="new_facility" class="modal fade" tabindex="-1" data-width="760">
...
{{ Html::script('js/facility/management.js') }}
